...
#blanks
touch ${outprefix}_ramalyze.log
touch ${outprefix}_rotalyze.log 
touch ${outprefix}_omegalyze.log
touch ${outprefix}_cbetadev.log
touch ${outprefix}_molprobity.log
touch ${t}molprobity_coot.py
