...
def get_untwist_atom_options_that_survived_unrestrained(pos_refined_model, pre_untwist_model, changes_only_model,max_gap_close_frac,min_ratio_real_sep_on_fake_sep,exclude_H):
