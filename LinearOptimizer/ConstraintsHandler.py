            ...
            for table_kind,table,interaction_str in zip(
              ...
              for i, (confA,confB,is_symm) in enumerate(table): # iterate over conformers
                ...
                if table_kind==ConstraintsHandler.ClashConstraint:
                    ...
                    #     print(min_separation)
                    # if all(c in [OrderedTag(26,"SG","A"),OrderedTag(34,"HA3","B")] for c in (confA,confB)):
                    #     print(confA,confB)
                    #     print(phenix_vdw(confA,confB,is_symm),is_symm)
                    #     print(min_separation)
                    # if all(c in [OrderedTag(26,"SG","B"),OrderedTag(34,"HA3","A")] for c in (confA,confB)):
                    #     print(confA,confB)
                    #     print(phenix_vdw(confA,confB,is_symm),is_symm)
                    #     print(min_separation)
                    #     adsasd
                    # if all(c in [OrderedTag(62,"NH1","A"),OrderedTag(102,"O","B")] for c in (confA,confB)):
                    #     print(confA,confB)
                    #     print(phenix_vdw(confA,confB,is_symm,table),is_symm)
                    #     print(min_separation)
                    # if all(c in [OrderedTag(62,"NH1","B"),OrderedTag(102,"O","A")] for c in (confA,confB)):
                    #     print(confA,confB)
                    #     print(phenix_vdw(confA,confB,is_symm,table),is_symm)
                    #     print(min_separation)
                    #     adsasd
