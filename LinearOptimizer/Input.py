...
class LP_Input:
    ...
    class Geomection(): # TODO really need to have a disordered connection class to have some of these properties (e.g. max site tension, outlier_ok)
        ...
        def __init__(self, atom_chunks:list[AtomChunk],ts_distance,position_option_indices:list[int],connection_type,hydrogen_names,ideal,z_score,actual,max_site_tension,outlier_ok):
